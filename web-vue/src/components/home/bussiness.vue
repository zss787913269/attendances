<template>
  <div class="main">
    ...
    <!-- 出差弹框 -->
    <el-dialog title="出差登记" :visible.sync="dialogFormVisible" >
    ...
    <div class="search-box">
      ...
      <div class="tablemain">
        <div class="crudbox">
          <el-button type="danger" icon="el-icon-plus" @click="handleTimeoff">出差登记</el-button>
        </div>
...
pagesize:10, 
  ...
  methods: {
    ...
    getLeaveMsgById() {
      ...
      this.axios
        .post("/bussiness/getIdfindBussiness", this.qs.stringify(obj))
        .then(res => {
